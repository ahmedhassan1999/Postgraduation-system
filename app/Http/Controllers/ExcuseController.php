...
class ExcuseController extends Controller
{
    ...
    public function updateexcuse(Request $request)
    {
       ...
       // $excuse->submittedDocURL=is_null($request->submittedDocURL) ? $excuse->submittedDocURL : $request->submittedDocURL->storePublicly('images');  $excuse->extendedPeriodDocURL=is_null($request->extendedPeriodDocURL) ? $excuse->extendedPeriodDocURL : $request->extendedPeriodDocURL->storePublicly('images');
